...
import static treptowkolleg.edu.extension.math.CMath.scaleFactor;
...
public class PlotApplication extends JFrame {
    ...
    public void reset(ActionEvent e) {
        // TODO: Die Werte sollten konsistenter Weise vom PlotSet kommen.
        X_DELTA = 0;
        Y_DELTA = 0;
        X_SCALE = 1;
        Y_SCALE = 1;
    ...
    public void setZoom(double x,  double y) {
        targetXScale = prepareScale(x);
        targetYScale = prepareScale(y);
        startZoomAnimation();
    }
    ...
    private void updateZoomInfo() {
        // TODO: nachdem auch werte < 1 möglich sind, muss die Berechnung nun anders sein.
