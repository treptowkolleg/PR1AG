...
public class PrintDecorator {
    ...
    /**
     * Constructs a {@link PrintDecorator} using the given
     * {@link PrintWriter}. The
    ...
    /**
     * Prints a border around the given text with default bottom margin of 1
     * line.
     *
     ...
     * <p>
     * The width of the border matches the length of the input text plus
     * padding.
     * </p>
     *
     * @param text         the text to determine the border width
