...
/**
 * A simple file reader utility class for reading text files with {@link java.util.Scanner}.
 * <p>
 * This class provides convenience constructors that automatically build
 * file paths based on {@link FileTarget} and optional subdirectories.
 * It handles file access errors gracefully by printing warnings to {@code System.err}.
 */
public class FileReader {
    ...
    /**
     * Creates a new FileReader instance for the specified file located under the given target path.
     *
     ...
     * <p>
     * If the file cannot be found, an error message is printed to {@code System.err}.
     */
    public void createScanner() {
        if (null != targetFile) {
            try {
                ...
                System.err.printf("File '%s' not found!%n", targetFile.getPath());
            }
        }
    }

    /**
     * Returns the current {@link Scanner} instance associated with this FileReader.
     *
     ...
     * <p>
     * This method should be called to release system resources after reading is complete.
     */
    public void close() {
