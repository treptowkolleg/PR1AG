 ...
 * <p>
 * This abstract class provides automated setup and teardown of input/output resources.
 * It standardizes the {@link Locale} to {@code Locale.US}, automatically executes the
 * subclass-defined {@link #run()} method after construction, and ensures that all
 * open {@link java.io.Closeable} resources (e.g., {@link FileReader}, {@link FileWriter})
 * are properly closed after execution.
 * </p>
 * <p>
...
public abstract class AbstractApplication {
    ...
    /**
     * Creates a new {@link FileReader} instance using the current subclass package hierarchy.
     *
     * @param fileName file name located within the {@code data} directory of the subclass.
    ...
    /**
     * Creates a new {@link FileReader} instance based on another class package hierarchy.
     * <p>
     * Example:
     * <ul>
     ...
     * </ul>
     *
     * @param classname class whose package hierarchy determines the relative data path.
    ...
    /**
     * Creates a new {@see Scanner} instance using the given input content.
     *
    ...
    /**
     * Creates a new {@link PrintWriter} instance for console output and a corresponding {@link PrintDecorator}.
     *
     * @return this instance for fluent method chaining.
     * @see PrintDecorator
     */
    ...
    /**
     * Creates a new {@link FileWriter} with a custom {@link FileTarget} and file name.
     * <p>
     * Example: {@code FileTarget.DATA_DIR, pr1.a02.Schachbrett.class -> ./data/a02/[filename]}
     *
     ...
     *
     * @param content @param content char sequence to be appended to the file output.
     */
    ...
    /**
     * Executes a {@link Consumer} function with the current {@link Scanner} with given input data.
     * <p>
     * The scanner must be initialized beforehand; otherwise, the closure will not be executed.
     *
    ...
    /**
     * Executes a {@link Consumer} function with the current {@link Scanner} from {@link FileReader}.
     * <p>
     * The file reader must be initialized beforehand; otherwise, the closure will not be executed.
     *
     * @param closure lambda function that processes the {@link Scanner}.
     * @see FileReader
     * @see Scanner
    ...
    /** Overload: executes {@code closure} for a specific file name in the subclass data path. */
    ...
    /** Returns the relative directory path based on the current subclass package hierarchy. */
    private String getDir() {
        return getDir(getClass());
    }

    /** Returns the relative directory path for the specified class package hierarchy. */
