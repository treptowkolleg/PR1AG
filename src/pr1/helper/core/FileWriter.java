...
/**
 * Utility class for creating and managing {@link PrintWriter} instances for
 * file output.
 * <p>
 * This class handles the creation of writable text files within a base
 * directory specified by {@link FileTarget}. It also ensures that non-existing
...
public class FileWriter {
    ...
    /**
     * Constructs a {@link FileWriter} using a {@link FileTarget} as base
     * directory
    ...
    public FileWriter(FileTarget targetPath, String file) {
        ...
        try {
            ...
            System.err.printf("File '%s' could not be created!%n",
                    baseDir + targetFile);
        }
    }
     ...
     * <p>
     * If the subdirectory does not exist, it will be created automatically
     * using
     * {@link File#mkdirs()}.
     * </p>
     * <p>
     * Example: if {@code FileTarget.DATA_DIR} resolves to {@code ./data/},
     * {@code path = "a02"} and {@code file = "result.txt"}, the resulting
     * file will
     * be {@code ./data/a02/result.txt}.
     * </p>
     *
     * @param targetPath the base directory defined by {@link FileTarget}.
     ...
     * {@link PrintWriter#print(String)},
     * {@link PrintWriter#printf(String, Object...)} or
    ...
    /**
     * Closes the underlying {@link PrintWriter} stream and releases all
     * associated
     * resources.
     * <p>
     * After calling this method, further write operations will throw a
     ...
     * <p>
     * This method is used internally by the constructors to define the
     * output file
     * name.
     * </p>
     *
