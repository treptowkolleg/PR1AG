...
public class FileWriter {
	 ...
	 * <p>
	 * If the subdirectory does not exist, it will be created automatically using
	 * {@link File#mkdirs()}.
	 * </p>
	 * <p>
	 * Example: if {@code FileTarget.DATA_DIR} resolves to {@code ./data/},
	 * {@code path = "a02"} and {@code file = "result.txt"}, the resulting file will
	...
	/**
	 * Closes the underlying {@link PrintWriter} stream and releases all associated
	 * resources.
	 * <p>
	 ...
	 * <p>
	 * This method is used internally by the constructors to define the output file
	 * name.
	 * </p>
	 *
