...
public class TrigonometrieControl extends PlotControl<TrigonometrieGraph> {
    ...
    public JPanel configureControls(ControlBuilder<TrigonometrieGraph> build) {
        return build
                ...
                .sliderDouble("Start", -12, 12, .5, TrigonometrieGraph::getIntervalStart, TrigonometrieGraph::setIntervalStart)
                .sliderDouble("Ende", -12, 12, .5, TrigonometrieGraph::getIntervalEnd, TrigonometrieGraph::setIntervalEnd)
                .getPanel();
    }
}
