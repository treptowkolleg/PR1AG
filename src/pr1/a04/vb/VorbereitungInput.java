...
public class VorbereitungInput extends AbstractApplication {
    ...
    public void scannerAusprobieren() {
        ...
        // ganze und Gleitkommazahlen aus der Datei data/testfiles/zahlen01.txt extrahieren
        decorator.printHeadline("Gemischte Zahlen aus Datei");
        // Standardmäßig wird als Pfad die Package-Hierarchie genutzt, daher zuerst zwei Ebenen höher gehen.
        withFileScanner("../../testfiles/zahlen01.txt", s ->
                print(formatScannedIntOrDouble(intFormat, doubleFormat, s)));
    }
